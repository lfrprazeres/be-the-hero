    ...
    return (
        <View style={style.container}> 
            ...
            <FlatList 
                ...
                onEndReached={loadIncidents} // diz uma função quando chega no final da lista
                onEndReachedThreshold={0.2} // diz quando a função vai executar (no caso em 20% da lista)
